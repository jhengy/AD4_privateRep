...
// ListView<T> is a control(which is a group of classes extending node) that allows you to display an ObservableList<T>
// https://www.tutorialspoint.com/javafx/javafx_application.htm --> for node class hierarchy
// layout (extends node: includes Pane) : https://www.tutorialspoint.com/javafx/javafx_layout_panes.html
public class FXListViewExample1 extends Application
{
    // Declaring the TextArea for Logging -> Panel for displaying selectionChanged - related message
    TextArea logging;
    ...
    public void start(Stage stage)
    {
        ...
        /*
         * note that we always wrap the smaller elements,i.e. Label,ListView into a
         * larger element VBox, which is again wrapped into an even larger element GridPane
         */
        // Create the Season VBox -> a container/div as in HTML
